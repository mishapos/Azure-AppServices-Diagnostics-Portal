import { Component, ViewChild, Input, EventEmitter, ViewEncapsulation, HostListener, Output, Injectable, ɵɵdefineInjectable, TemplateRef, Type, ViewContainerRef, ComponentFactoryResolver, Directive, ElementRef, HostBinding, NgModule } from '@angular/core';
...
const _c0 = ["arrow"];
const _c1 = function (a0, a1, a2, a3, a4) { return { height: a0, width: a1, left: a2, top: a3, opacity: a4 }; };
const _c2 = ["canvasContent"];
function NgFlowchartStepComponent_ng_container_2_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelementContainer(0);
} }
const _c3 = function (a0, a1) { return { data: a0, id: a1 }; };
...
NgFlowchartArrowComponent.ɵfac = function NgFlowchartArrowComponent_Factory(t) { return new (t || NgFlowchartArrowComponent)(); };
NgFlowchartArrowComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: NgFlowchartArrowComponent, selectors: [["lib-ng-flowchart-arrow"]], viewQuery: function NgFlowchartArrowComponent_Query(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵviewQuery(_c0, 1);
    } if (rf & 2) {
        let _t;
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx.arrow = _t.first);
    } }, inputs: { position: "position" }, decls: 7, vars: 7, consts: [["xmlns", "http://www.w3.org/2000/svg", 1, "ngflowchart-arrow", 3, "ngStyle"], ["id", "arrowhead", "viewBox", "0 0 10 10", "refX", "3", "refY", "5", "markerWidth", "5", "markerHeight", "5", "orient", "auto", "fill", "grey"], ["d", "M 0 0 L 10 5 L 0 10 z"], ["id", "arrowpath", "fill", "none", "stroke", "grey", "stroke-width", "2", "marker-end", "url(#arrowhead)"], ["id", "arrow"], ["arrow", ""]], template: function NgFlowchartArrowComponent_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵnamespaceSVG();
        ɵngcc0.ɵɵelementStart(0, "svg", 0);
        ɵngcc0.ɵɵelementStart(1, "defs");
        ɵngcc0.ɵɵelementStart(2, "marker", 1);
        ɵngcc0.ɵɵelement(3, "path", 2);
        ɵngcc0.ɵɵelementEnd();
        ɵngcc0.ɵɵelementEnd();
        ɵngcc0.ɵɵelementStart(4, "g", 3);
        ɵngcc0.ɵɵelement(5, "path", 4, 5);
        ɵngcc0.ɵɵelementEnd();
        ɵngcc0.ɵɵelementEnd();
    } if (rf & 2) {
        ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction5(1, _c1, ctx.containerHeight + "px", ctx.containerWidth + "px", ctx.containerLeft + "px", ctx.containerTop + "px", ctx.opacity));
    } }, directives: [ɵngcc1.NgStyle], styles: ["svg[_ngcontent-%COMP%]{position:absolute;z-index:0;transition:all .2s}"] });
NgFlowchartArrowComponent.ctorParameters = () => [];
NgFlowchartArrowComponent.propDecorators = {
    arrow: [{ type: ViewChild, args: ['arrow',] }],
    position: [{ type: Input }]
};
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(NgFlowchartArrowComponent, [{
        type: Component,
        args: [{
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(NgFlowchartStepComponent, [{
        type: Component,
        args: [{
...
CanvasRendererService.ɵfac = function CanvasRendererService_Factory(t) { return new (t || CanvasRendererService)(ɵngcc0.ɵɵinject(OptionsService)); };
CanvasRendererService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: CanvasRendererService, factory: CanvasRendererService.ɵfac });
CanvasRendererService.ctorParameters = () => [
    { type: OptionsService }
];
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(CanvasRendererService, [{
        type: Injectable
...
DropDataService.ɵfac = function DropDataService_Factory(t) { return new (t || DropDataService)(); };
DropDataService.ɵprov = ɵɵdefineInjectable({ factory: function DropDataService_Factory() { return new DropDataService(); }, token: DropDataService, providedIn: "root" });
DropDataService.ctorParameters = () => [];
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(DropDataService, [{
        type: Injectable,
        args: [{
                providedIn: 'root'
            }]
...
NgFlowchartStepRegistry.ɵfac = function NgFlowchartStepRegistry_Factory(t) { return new (t || NgFlowchartStepRegistry)(); };
NgFlowchartStepRegistry.ɵprov = ɵɵdefineInjectable({ factory: function NgFlowchartStepRegistry_Factory() { return new NgFlowchartStepRegistry(); }, token: NgFlowchartStepRegistry, providedIn: "root" });
NgFlowchartStepRegistry.ctorParameters = () => [];
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(NgFlowchartStepRegistry, [{
        type: Injectable,
        args: [{
                providedIn: 'root'
            }]
...
StepManagerService.ɵfac = function StepManagerService_Factory(t) { return new (t || StepManagerService)(ɵngcc0.ɵɵinject(ɵngcc0.ComponentFactoryResolver), ɵngcc0.ɵɵinject(NgFlowchartStepRegistry)); };
StepManagerService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: StepManagerService, factory: StepManagerService.ɵfac });
StepManagerService.ctorParameters = () => [
    { type: ComponentFactoryResolver },
    { type: NgFlowchartStepRegistry }
];
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(StepManagerService, [{
        type: Injectable
    }], function () { return [{ type: ɵngcc0.ComponentFactoryResolver }, { type: NgFlowchartStepRegistry }]; }, null); })();
...
class NgFlowchartCanvasService {
    ...
    createStepFromType(id, type, data) {
        ...
        return new Promise((resolve) => {
            let sub = compRef.instance.viewInit.subscribe(() => __awaiter$2(this, void 0, void 0, function* () {
                sub.unsubscribe();
                setTimeout(() => {
...
NgFlowchartCanvasService.ɵfac = function NgFlowchartCanvasService_Factory(t) { return new (t || NgFlowchartCanvasService)(ɵngcc0.ɵɵinject(DropDataService), ɵngcc0.ɵɵinject(OptionsService), ɵngcc0.ɵɵinject(CanvasRendererService), ɵngcc0.ɵɵinject(StepManagerService)); };
NgFlowchartCanvasService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: NgFlowchartCanvasService, factory: NgFlowchartCanvasService.ɵfac });
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(NgFlowchartCanvasService, [{
        type: Injectable
    }], function () { return [{ type: DropDataService }, { type: OptionsService }, { type: CanvasRendererService }, { type: StepManagerService }]; }, null); })();
...
NgFlowchartCanvasDirective.ɵfac = function NgFlowchartCanvasDirective_Factory(t) { return new (t || NgFlowchartCanvasDirective)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ViewContainerRef), ɵngcc0.ɵɵdirectiveInject(NgFlowchartCanvasService), ɵngcc0.ɵɵdirectiveInject(OptionsService)); };
NgFlowchartCanvasDirective.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: NgFlowchartCanvasDirective, selectors: [["", "ngFlowchartCanvas", ""]], hostVars: 1, hostBindings: function NgFlowchartCanvasDirective_HostBindings(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵlistener("drop", function NgFlowchartCanvasDirective_drop_HostBindingHandler($event) { return ctx.onDrop($event); })("dragover", function NgFlowchartCanvasDirective_dragover_HostBindingHandler($event) { return ctx.onDragOver($event); })("resize", function NgFlowchartCanvasDirective_resize_HostBindingHandler($event) { return ctx.onResize($event); }, false, ɵngcc0.ɵɵresolveWindow)("wheel", function NgFlowchartCanvasDirective_wheel_HostBindingHandler($event) { return ctx.onZoom($event); });
    } if (rf & 2) {
        ɵngcc0.ɵɵattribute("disabled", ctx.disabled);
    } }, inputs: { callbacks: ["ngFlowchartCallbacks", "callbacks"], options: ["ngFlowchartOptions", "options"], disabled: "disabled" }, features: [ɵngcc0.ɵɵProvidersFeature([
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(NgFlowchartCanvasDirective, [{
        type: Directive,
        args: [{
    ...
    }], function () { return [{ type: ɵngcc0.ElementRef }, { type: ɵngcc0.ViewContainerRef }, { type: NgFlowchartCanvasService }, { type: OptionsService }]; }, { onDrop: [{
            type: HostListener,
            args: ['drop', ['$event']]
        }], onDragOver: [{
            type: HostListener,
...
NgFlowchartStepDirective.ɵfac = function NgFlowchartStepDirective_Factory(t) { return new (t || NgFlowchartStepDirective)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(DropDataService)); };
NgFlowchartStepDirective.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: NgFlowchartStepDirective, selectors: [["", "ngFlowchartStep", ""]], hostBindings: function NgFlowchartStepDirective_HostBindings(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵlistener("dragstart", function NgFlowchartStepDirective_dragstart_HostBindingHandler($event) { return ctx.onDragStart($event); })("dragend", function NgFlowchartStepDirective_dragend_HostBindingHandler($event) { return ctx.onDragEnd($event); });
    } }, inputs: { flowStep: ["ngFlowchartStep", "flowStep"] } });
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(NgFlowchartStepDirective, [{
        type: Directive,
        args: [{
                selector: '[ngFlowchartStep]'
            }]
    }], function () { return [{ type: ɵngcc0.ElementRef }, { type: DropDataService }]; }, { onDragStart: [{
            type: HostListener,
            args: ['dragstart', ['$event']]
        }], onDragEnd: [{
            type: HostListener,
...
NgFlowchartModule.ɵfac = function NgFlowchartModule_Factory(t) { return new (t || NgFlowchartModule)(); };
NgFlowchartModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: NgFlowchartModule });
NgFlowchartModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ imports: [[
            CommonModule
        ]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(NgFlowchartModule, { declarations: function () { return [NgFlowchartCanvasDirective, NgFlowchartStepDirective, NgFlowchartStepComponent, NgFlowchartArrowComponent]; }, imports: function () { return [CommonModule]; }, exports: function () { return [NgFlowchartCanvasDirective, NgFlowchartStepDirective, NgFlowchartStepComponent, NgFlowchartArrowComponent]; } }); })();
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(NgFlowchartModule, [{
        type: NgModule,
        args: [{
...
export { NgFlowchart, NgFlowchartArrowComponent, NgFlowchartCanvasDirective, NgFlowchartModule, NgFlowchartStepComponent, NgFlowchartStepDirective, NgFlowchartStepRegistry, OptionsService, NgFlowchartCanvasService as ɵa, DropDataService as ɵb, CanvasRendererService as ɵc, StepManagerService as ɵd };

//# sourceMappingURL=joelwenzel-ng-flowchart.js.map